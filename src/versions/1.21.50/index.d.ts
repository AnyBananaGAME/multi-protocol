...
declare enum Packet {
    ...
    ServerboundDiagnosticPacket = 315,// 315
    MovementEffect = 318
}
...
declare enum PredictionType {
    Player = 0,
    Vehicle = 1
}

declare enum MovementEffectType {
    GlideBoost = 0
}

declare enum ItemTrackedType {
    Entity = 0,
    BlockEntity = 1,
    Other = 2
}

declare enum MapDecorationType {
    MarkerWhite = 0,
    MarkerGreen = 1,
    MarkerRed = 2,
    MarkerBlue = 3,
...
declare enum PredictedResult {
    Failure = 0,
    Success = 1
}

declare enum GameRule {
...
declare class BlockPosition extends DataType implements IPosition {
     ...
     */
    distanceManhattan(other: IPosition): number;
    /**
...
declare class ItemInstanceUserData extends DataType {
     ...
     */
    constructor(nbt: CompoundTag<unknown> | null, canPlaceOn: Array<string>, canDestroy: Array<string>, ticking?: bigint | null);
...
declare class ComponentItem extends DataType {
    readonly name: string;
    readonly data: CompoundTag<unknown>;
    constructor(name: string, data: CompoundTag<unknown>);
...
declare class NbtLoop extends DataType {
    data: CompoundTag<unknown> | null;
    constructor(data: CompoundTag<unknown> | null);
...
declare class MapTextureUpdateBits extends DataType {
    static write(stream: BinaryStream, value: number | Array<number>, _: Endianness, parameter: number): void;
}

declare class MapTrackedItem extends DataType {
    type: ItemTrackedType;
    uniqueId?: bigint;
    position?: BlockPosition;
    constructor(type: number, uniqueId?: bigint, position?: BlockPosition);
    static write(stream: BinaryStream, value: MapTrackedItem): void;
    static read(stream: BinaryStream): MapTrackedItem;
}

declare class MapDecorationBits extends DataType {
    static write(stream: BinaryStream, value: Array<MapDecoration>, _: Endianness, parameter: number): void;
    static read(stream: BinaryStream, _: Endianness, parameter: number): Array<MapTrackedItem> | Array<MapDecoration> | null;
}
declare class MapTrackedItems extends DataType {
    static write(stream: BinaryStream, value: Array<MapTrackedItem>, _: Endianness, parameter: number): void;
    static read(stream: BinaryStream, _: Endianness, parameter: number): Array<MapTrackedItem> | null;
}

declare class MapCreationBits extends DataType {
    static write(stream: BinaryStream, value: Array<bigint>, _: Endianness, parameter: number): void;
    static read(stream: BinaryStream, _: Endianness, parameter: number): Array<bigint> | null;
}

declare class MapDecoration extends DataType {
    ...
    label: string;
    color: number;
    constructor(type: number, rotation: number, x: number, y: number, label: string, color: number);
    static write(stream: BinaryStream, value: MapDecoration): void;
    static read(stream: BinaryStream): MapDecoration;
}

declare class MapScale extends DataType {
    static write(stream: BinaryStream, value: number, _: Endianness, parameter: number): void;
    static read(stream: BinaryStream, _: Endianness, parameter: number): number | null;
    private static checkFlag;
}

declare class MapPixel extends DataType {
    x: number;
    y: number;
    color: Color;
    constructor(x: number, y: number, color: Color);
    static write(stream: BinaryStream, value: Array<MapPixel>): void;
    static read(stream: BinaryStream): Array<MapPixel> | null;
}

declare class TradeOffer extends DataType {
    ...
    uses: number;
    constructor(buyA: CompoundTag<unknown>, buyB: CompoundTag<unknown> | null, sell: CompoundTag<unknown>, maxUses: number, experienceReward: number, tier: number, traderExperience: number);
    static write(stream: BinaryStream, value: Array<TradeOffer>): void;
}

declare class PlayerAuthInputTransaction extends DataType {
    inputTransaction: InputTransaction;
    constructor(inputTransaction: InputTransaction);
    static write(stream: BinaryStream, value: InputTransaction, _: unknown, data: PlayerAuthInputData): void;
...
declare class ShowProfilePacket extends DataPacket {
    xuid: string;
}

declare class DebugInfoPacket extends DataPacket {
    actorUniqueId: bigint;
    data: string;
}

declare class ClientBoundDebugRendererPacket extends DataPacket {
    type: number;
    text: string;
    position: Vector3f;
    red: number;
...
declare class MovementEffectPacket extends DataPacket {
    runtimeId: bigint;
...
declare class ClientBoundMapItemDataPacket extends DataPacket {
    mapId: bigint;
    flags: number;
    dimension: number;
    isLocked: boolean;
    origin: BlockPosition;
    mapIncludedIn: Array<bigint> | null;
    scale: number | null;
    trackedActors: Array<MapTrackedItem> | null;
    decorations: Array<MapDecoration> | null;
    width: number | null;
    height: number | null;
...
declare class MapInfoRequestPacket extends DataPacket {
    mapId: bigint;
    mapPixels: Array<MapPixel>;
}

declare class UpdateTradePacket extends DataPacket {
    windowId: ContainerId;
    containerType: ContainerType;
    size: number;
    tradeTier: number;
    tradeActorUnique: bigint;
    playerTradingUnique: bigint;
    displayName: string;
    useNewUI: boolean;
    economyTrade: boolean;
...
declare const PROTOCOL_VERSION = 766;
declare const MINECRAFT_VERSION = "1.21.51";
